...
describe('conversion utils', function () {
  ...
  describe('conversionUtil', function () {
    it('Returns expected types', function () {
      ...
      const conv2 = conversionUtil(1, { fromNumericBase: 'dec', fromDenomination: 'WAN', toDenomination: 'WEI' })
    ...
    it('Converts WEI to WAN', function () {
      assert.equal(conversionUtil('0xde0b6b3a7640000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'WEI', toDenomination: 'WAN' }), 1)
      assert.equal(conversionUtil('0x14d1120d7b160000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'WEI', toDenomination: 'WAN' }), 1.5)
    })
    it('Converts WAN to WEI', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'WAN', toDenomination: 'WEI' }), 1000000000000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'WAN', toDenomination: 'WEI' }), 1500000000000000000)
    })
    it('Converts WAN to GWEI', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'WAN', toDenomination: 'GWEI' }), 1000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'WAN', toDenomination: 'GWEI' }), 1500000000)
    })
